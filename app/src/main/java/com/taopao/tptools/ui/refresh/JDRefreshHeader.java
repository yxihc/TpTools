...
public class JDRefreshHeader extends LinearLayout implements RefreshHeader {
    ...
    public JDRefreshHeader(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JDRefreshHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
