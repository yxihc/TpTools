...
public class MTRefreshHeader extends LinearLayout implements RefreshHeader {
    ...
    public MTRefreshHeader(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MTRefreshHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
