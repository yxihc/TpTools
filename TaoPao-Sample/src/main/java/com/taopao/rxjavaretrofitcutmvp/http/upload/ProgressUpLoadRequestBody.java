package com.taopao.rxjavaretrofitcutmvp.http.upload;
...
public class ProgressUpLoadRequestBody extends RequestBody {
    ...
    public ProgressUpLoadRequestBody(RequestBody requestBody, UploadProgressListener progressListener) {
