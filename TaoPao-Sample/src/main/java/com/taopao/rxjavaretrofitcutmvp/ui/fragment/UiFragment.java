...
import com.taopao.rxjavaretrofitcutmvp.ui.activity.customview.TakePhotoActivity;
...
public class UiFragment extends Fragment implements BaseQuickAdapter.OnItemClickListener {
    private final int[] picResId = new int[]{R.mipmap.p5,R.mipmap.p5, R.mipmap.p33, R.mipmap.p33,R.mipmap.p6, R.mipmap.p7,R.mipmap.p8,R.mipmap.p12,R.mipmap.p12,R.mipmap.p12};
    private final String[] mTitles = new String[]{"随机显示TextView", "Dialog",
            "仿微信朋友圈下拉刷新","仿微信带进度条网页","RecyclerView拖动","Glide使用","BaseRecyclerViewAdapterHelper", "仿美团下拉刷新", "仿京东到家下拉刷新", "图片选择"};
